                ...
                <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <p className="card-text">
                            <div className={'row'}>
                                <div className={'col'}>
                                    <span className={'fw-bold pe-2'}>{currentUser && currentUser.following}</span>
                                    <span className={'text-secondary'}>Following</span>
                                </div>
                                <div className={'col'}>
                                    <span className={'fw-bold pe-2'}>{currentUser && currentUser.followers}</span>
            ...
            <div className="col-xl-9 col-lg-8 col-md-7 col-sm mt-2">
                <Tabs defaultActiveKey="first" variant={'pills'} fill={true}>
                    <Tab tabClassName={'wd-profile-tabs'}
                        ...
                        <WatchListTable uid={currentUser && currentUser._id} allowedToRemove={true}/>
                    </Tab>
                    <Tab tabClassName={'wd-profile-tabs'}
